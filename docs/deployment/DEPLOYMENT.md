...
| ai | Trigger.dev deploy | Trigger cloud | `npm run deploy` (version pinned in `ai/package.json` devDependencies — see `ai/project-kit/feature-specs/01-trigger-setup.md`) | Deactivate task / redeploy |
