...
- AI never writes to SQL Server directly. Every read/write goes through the backend GraphQL with `GRIOT_SERVICE_TOKEN` (resolved to the restricted `ai-agent` principal).
