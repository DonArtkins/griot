...
Week 2. Spec 02 is complete (EF Core entities, DbContext, and initial migration created). Spec 03 is next.

| Spec | Title | Status |
|---|---|---|
| 01 | ERD & schema design (Figma/Figma Make) | ✅ Done |
| 02 | SQL Server implementation (EF Core) | ✅ Done |
| 03 | Stored procedures & optimized queries | Next |
...
1. Implement spec 03 (Stored procedures & optimized queries).
