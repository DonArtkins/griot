...
| OrganizationController | `/api/organizations*` — platform CRUD + lifecycle + invite accept (RoleController owns the org-scoped `roles*` + member-role routes) | OrganizationLifecycleService |
