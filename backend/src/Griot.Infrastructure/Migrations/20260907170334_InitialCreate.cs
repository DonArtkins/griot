        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixStatus = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SolvedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ErrorLogs_Users_SolvedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetRef = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_ActivityLogs_ActivityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Position = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ErrorLogs_FixedAt",
                table: "ErrorLogs",
                column: "FixedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ErrorLogs_FixStatus",
                table: "ErrorLogs",
                column: "FixStatus",
                filter: "[FixStatus] IN ('Open', 'Investigating')");

            migrationBuilder.CreateIndex(
                name: "IX_ErrorLogs_SolvedByUserId",
                table: "ErrorLogs",
