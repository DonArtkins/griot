...
**v2 roster (spec 06, PLANNED):** `list_reports`, `get_report`, `generate_report`, `download_report`, `system_audit`, `get_audit_log`, `get_metrics` — same implementations as ai 06/07 via backend 20/24; v1 9-tool roster unchanged until mcp 02 ships; never OTP/auth/delete/invite/member tools.
